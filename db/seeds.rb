...
james = Customer.create(username: 'jameswmoody', password: 'password', vault_id: 'braintreesecret', first_name: 'James', last_name: 'Moody', phone: '+13121234567', email: 'james@james.com')
evan = Customer.create(username: 'ehickle', password: 'password', vault_id: 'braintreesecret', first_name: 'Evan', last_name: 'Hickle', phone: '+13121234568', email: 'evan@evan.com')
nico = Customer.create(username: 'nicoglennon', password: 'password', vault_id: 'braintreesecret', first_name: 'Nico', last_name: 'Glennon', phone: '+13121234569', email: 'nico@nico.com')
josh = Customer.create(username: 'jmharvey0', password: 'password', vault_id: 'braintreesecret', first_name: 'Josh', last_name: 'Harvey', phone: '+13121234560', email: 'josh@josh.com')
